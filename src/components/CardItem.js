...
function CardItem({ to, category, location, date, title, description, people, comments, imageUrl, icon}) {
    ...
    <Box className="group-cardContainer">
      ...
      <Box className="group-cardContent">
        <Box className="group-cardHeader">
          <Typography variant="caption" className="group-category">{category}</Typography>
          <Divider orientation="vertical" flexItem sx={{ mx: 1 }} />
          <LocationOnIcon fontSize="small" sx={{ color: '#909090' }} />
          <Typography variant="caption" className="group-location">{location} {date}</Typography>
          <Box className="group-recruitingBox">모집중</Box>
        </Box>

        <Typography variant="h6" className="group-title">{title}</Typography>
        <Typography variant="body2" className="group-description">{description}</Typography>

        <Box className="group-cardFooter">
          <PeopleIcon fontSize="small" className="group-icon" />
          <Typography variant="caption">{people}</Typography>
          <ChatBubbleOutlineIcon fontSize="small" className="group-icon group-commentIcon" />
